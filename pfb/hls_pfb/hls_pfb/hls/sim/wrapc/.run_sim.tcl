...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "pfb_multichannel.autotvin.dat"
	set constFileTvOut       "pfb_multichannel.autotvout.dat"
	set constFileHdlTvIn     "pfb_multichannel.autohdltvin.dat"
	set constFileHdlTvOut    "pfb_multichannel.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
