...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { din_data_i0_TVALID { I 1 bit } din_data_i0_TDATA { I 16 vector } din_data_i0_TREADY { O 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { din_data_q0_TVALID { I 1 bit } din_data_q0_TDATA { I 16 vector } din_data_q0_TREADY { O 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { din_data_i1_TVALID { I 1 bit } din_data_i1_TDATA { I 16 vector } din_data_i1_TREADY { O 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { din_data_q1_TVALID { I 1 bit } din_data_q1_TDATA { I 16 vector } din_data_q1_TREADY { O 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { din_data_i2_TVALID { I 1 bit } din_data_i2_TDATA { I 16 vector } din_data_i2_TREADY { O 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { din_data_q2_TVALID { I 1 bit } din_data_q2_TDATA { I 16 vector } din_data_q2_TREADY { O 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { din_data_i3_TVALID { I 1 bit } din_data_i3_TDATA { I 16 vector } din_data_i3_TREADY { O 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { din_data_q3_TVALID { I 1 bit } din_data_q3_TDATA { I 16 vector } din_data_q3_TREADY { O 1 bit } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { stream_read_to_compute_din { O 128 vector } stream_read_to_compute_num_data_valid { I 5 vector } stream_read_to_compute_fifo_cap { I 5 vector } stream_read_to_compute_full_n { I 1 bit } stream_read_to_compute_write { O 1 bit } } \
} "
}
