...
%"class.hls::stream<ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>, 0>" = type { %"struct.ap_fixed<32, 2, AP_TRN, AP_WRAP, 0>" }
...
entry:
  ...
  call void @apatb_pfb_multichannel_decimator_hw(i16* %din_data_i0_copy, i16* %din_data_q0_copy, i16* %din_data_i1_copy, i16* %din_data_q1_copy, i16* %din_data_i2_copy, i16* %din_data_q2_copy, i16* %din_data_i3_copy, i16* %din_data_q3_copy, i32* %dout_data_0_copy, i32* %dout_data_1_copy, i32* %dout_data_2_copy, i32* %dout_data_3_copy, [4096 x i16]* %coeff_copy)
...
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_fixed<16, 1, AP_TRN, AP_WRAP, 0>, 0>.56"(%"class.hls::stream<ap_fixed<16, 1, AP_TRN, AP_WRAP, 0>, 0>"* %0, i16* align 512 %1)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_fixed<16, 1, AP_TRN, AP_WRAP, 0>, 0>.56"(%"class.hls::stream<ap_fixed<16, 1, AP_TRN, AP_WRAP, 0>, 0>"* %2, i16* align 512 %3)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_fixed<16, 1, AP_TRN, AP_WRAP, 0>, 0>.56"(%"class.hls::stream<ap_fixed<16, 1, AP_TRN, AP_WRAP, 0>, 0>"* %4, i16* align 512 %5)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_fixed<16, 1, AP_TRN, AP_WRAP, 0>, 0>.56"(%"class.hls::stream<ap_fixed<16, 1, AP_TRN, AP_WRAP, 0>, 0>"* %6, i16* align 512 %7)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_fixed<16, 1, AP_TRN, AP_WRAP, 0>, 0>.56"(%"class.hls::stream<ap_fixed<16, 1, AP_TRN, AP_WRAP, 0>, 0>"* %8, i16* align 512 %9)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_fixed<16, 1, AP_TRN, AP_WRAP, 0>, 0>.56"(%"class.hls::stream<ap_fixed<16, 1, AP_TRN, AP_WRAP, 0>, 0>"* %10, i16* align 512 %11)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_fixed<16, 1, AP_TRN, AP_WRAP, 0>, 0>.56"(%"class.hls::stream<ap_fixed<16, 1, AP_TRN, AP_WRAP, 0>, 0>"* %12, i16* align 512 %13)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_fixed<16, 1, AP_TRN, AP_WRAP, 0>, 0>.56"(%"class.hls::stream<ap_fixed<16, 1, AP_TRN, AP_WRAP, 0>, 0>"* %14, i16* align 512 %15)
  ...
  call fastcc void @"onebyonecpy_hls.p0a4096struct.ap_fixed<16, 1, AP_TRN, AP_WRAP, 0>.10"([4096 x %"struct.ap_fixed<16, 1, AP_TRN, AP_WRAP, 0>"]* %24, [4096 x i16]* %25)
  ret void
}
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @"onebyonecpy_hls.p0a4096struct.ap_fixed<16, 1, AP_TRN, AP_WRAP, 0>.10"([4096 x %"struct.ap_fixed<16, 1, AP_TRN, AP_WRAP, 0>"]* noalias "unpacked"="0" %dst, [4096 x i16]* noalias nocapture readonly "unpacked"="1.0" %src) unnamed_addr #3 {
entry:
  %0 = icmp eq [4096 x %"struct.ap_fixed<16, 1, AP_TRN, AP_WRAP, 0>"]* %dst, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a4096struct.ap_fixed<16, 1, AP_TRN, AP_WRAP, 0>.13"([4096 x %"struct.ap_fixed<16, 1, AP_TRN, AP_WRAP, 0>"]* nonnull %dst, [4096 x i16]* %src, i64 4096)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a4096struct.ap_fixed<16, 1, AP_TRN, AP_WRAP, 0>.13"([4096 x %"struct.ap_fixed<16, 1, AP_TRN, AP_WRAP, 0>"]* "unpacked"="0" %dst, [4096 x i16]* nocapture readonly "unpacked"="1.0" %src, i64 "unpacked"="2" %num) local_unnamed_addr #4 {
entry:
  %0 = icmp eq [4096 x %"struct.ap_fixed<16, 1, AP_TRN, AP_WRAP, 0>"]* %dst, null
  br i1 %0, label %ret, label %copy
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<ap_fixed<16, 1, AP_TRN, AP_WRAP, 0>, 0>.52"(i16* align 512 %dst, %"class.hls::stream<ap_fixed<16, 1, AP_TRN, AP_WRAP, 0>, 0>"* nonnull %src)
  br label %ret
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<ap_fixed<16, 1, AP_TRN, AP_WRAP, 0>, 0>.52"(i16* noalias nocapture align 512 "unpacked"="0.0", %"class.hls::stream<ap_fixed<16, 1, AP_TRN, AP_WRAP, 0>, 0>"* noalias nocapture "unpacked"="1") unnamed_addr #7 {
entry:
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_fixed<16, 1, AP_TRN, AP_WRAP, 0>, 0>.56"(%"class.hls::stream<ap_fixed<16, 1, AP_TRN, AP_WRAP, 0>, 0>"* noalias "unpacked"="0" %dst, i16* noalias nocapture align 512 "unpacked"="1.0" %src) unnamed_addr #6 {
entry:
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<ap_fixed<16, 1, AP_TRN, AP_WRAP, 0>, 0>.59"(%"class.hls::stream<ap_fixed<16, 1, AP_TRN, AP_WRAP, 0>, 0>"* noalias nocapture "unpacked"="0", i16* noalias nocapture align 512 "unpacked"="1.0") unnamed_addr #7 {
entry:
  %2 = alloca i16
...
declare void @apatb_pfb_multichannel_decimator_hw(i16*, i16*, i16*, i16*, i16*, i16*, i16*, i16*, i32*, i32*, i32*, i32*, [4096 x i16]*)
...
define void @pfb_multichannel_decimator_hw_stub_wrapper(i16*, i16*, i16*, i16*, i16*, i16*, i16*, i16*, i32*, i32*, i32*, i32*, [4096 x i16]*) #8 {
entry:
...
declare void @pfb_multichannel_decimator_hw_stub(%"class.hls::stream<ap_fixed<16, 1, AP_TRN, AP_WRAP, 0>, 0>"*, %"class.hls::stream<ap_fixed<16, 1, AP_TRN, AP_WRAP, 0>, 0>"*, %"class.hls::stream<ap_fixed<16, 1, AP_TRN, AP_WRAP, 0>, 0>"*, %"class.hls::stream<ap_fixed<16, 1, AP_TRN, AP_WRAP, 0>, 0>"*, %"class.hls::stream<ap_fixed<16, 1, AP_TRN, AP_WRAP, 0>, 0>"*, %"class.hls::stream<ap_fixed<16, 1, AP_TRN, AP_WRAP, 0>, 0>"*, %"class.hls::stream<ap_fixed<16, 1, AP_TRN, AP_WRAP, 0>, 0>"*, %"class.hls::stream<ap_fixed<16, 1, AP_TRN, AP_WRAP, 0>, 0>"*, %"class.hls::stream<ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>, 0>"*, %"class.hls::stream<ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>, 0>"*, %"class.hls::stream<ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>, 0>"*, %"class.hls::stream<ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>, 0>"*, %"struct.ap_fixed<16, 1, AP_TRN, AP_WRAP, 0>"*)
