...
set C_modelArgList {
	{ stream_fft_to_write int 128 regular {fifo 0 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "stream_fft_to_write", "interface" : "fifo", "bitwidth" : 128, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ stream_fft_to_write_dout sc_in sc_lv 128 signal 0 } 
	{ stream_fft_to_write_num_data_valid sc_in sc_lv 5 signal 0 } 
	{ stream_fft_to_write_fifo_cap sc_in sc_lv 5 signal 0 } 
	{ stream_fft_to_write_empty_n sc_in sc_logic 1 signal 0 } 
	{ stream_fft_to_write_read sc_out sc_logic 1 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "stream_fft_to_write_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "stream_fft_to_write", "role": "dout" }} , 
 	...
 	{ "name": "stream_fft_to_write_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "stream_fft_to_write", "role": "empty_n" }} , 
 	{ "name": "stream_fft_to_write_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "stream_fft_to_write", "role": "read" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "3", "4", "5", "6"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "stream_fft_to_write", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0","-1"], "DependentChan" : "0", "DependentChanDepth" : "16", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_write_outputs_Pipeline_write_loop_fu_34", "Port" : "stream_fft_to_write", "Inst_start_state" : "1", "Inst_end_state" : "2"}]},
			{"Name" : "dout_data_0", "Type" : "Axis", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_write_outputs_Pipeline_write_loop_fu_34", "Port" : "dout_data_0", "Inst_start_state" : "1", "Inst_end_state" : "2"}]},
			{"Name" : "dout_data_1", "Type" : "Axis", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_write_outputs_Pipeline_write_loop_fu_34", "Port" : "dout_data_1", "Inst_start_state" : "1", "Inst_end_state" : "2"}]},
			{"Name" : "dout_data_2", "Type" : "Axis", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_write_outputs_Pipeline_write_loop_fu_34", "Port" : "dout_data_2", "Inst_start_state" : "1", "Inst_end_state" : "2"}]},
			{"Name" : "dout_data_3", "Type" : "Axis", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_write_outputs_Pipeline_write_loop_fu_34", "Port" : "dout_data_3", "Inst_start_state" : "1", "Inst_end_state" : "2"}]},
			{"Name" : "dummy_state", "Type" : "OVld", "Direction" : "IO"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_write_outputs_Pipeline_write_loop_fu_34", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_write_outputs_Pipeline_write_loop_fu_34.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_dout_data_0_U", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_dout_data_1_U", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_dout_data_2_U", "Parent" : "0"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_dout_data_3_U", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	stream_fft_to_write { ap_fifo {  { stream_fft_to_write_dout fifo_data_in 0 128 }  { stream_fft_to_write_num_data_valid fifo_status_num_data_valid 0 5 }  { stream_fft_to_write_fifo_cap fifo_update 0 5 }  { stream_fft_to_write_empty_n fifo_status 0 1 }  { stream_fft_to_write_read fifo_port_we 1 1 } } }
