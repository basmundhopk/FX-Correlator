...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.pfb_multichannel.autotvin_gmem.dat"
         "c.pfb_multichannel.autotvin_din_data_i0.dat"
         "c.pfb_multichannel.autotvin_din_data_q0.dat"
         "c.pfb_multichannel.autotvin_din_data_i1.dat"
         "c.pfb_multichannel.autotvin_din_data_q1.dat"
         "c.pfb_multichannel.autotvin_din_data_i2.dat"
         "c.pfb_multichannel.autotvin_din_data_q2.dat"
         "c.pfb_multichannel.autotvin_din_data_i3.dat"
         "c.pfb_multichannel.autotvin_din_data_q3.dat"
         "c.pfb_multichannel.autotvin_coeff.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.pfb_multichannel.autotvout_dout_data_0.dat"
         "rtl.pfb_multichannel.autotvout_dout_data_1.dat"
         "rtl.pfb_multichannel.autotvout_dout_data_2.dat"
         "rtl.pfb_multichannel.autotvout_dout_data_3.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
