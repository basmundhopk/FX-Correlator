...
entity pfb_multichannel_start_for_fft_U0 is 
    generic (
...
architecture rtl of pfb_multichannel_start_for_fft_U0 is

    component pfb_multichannel_start_for_fft_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_pfb_multichannel_start_for_fft_U0_ShiftReg : pfb_multichannel_start_for_fft_U0_ShiftReg
    generic map (
...
entity pfb_multichannel_start_for_fft_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end pfb_multichannel_start_for_fft_U0_ShiftReg;

architecture rtl of pfb_multichannel_start_for_fft_U0_ShiftReg is
