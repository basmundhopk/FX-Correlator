create_ip -vlnv xilinx.com:ip:xfft -module_name pfb_multichannel_fft_syn_config1_4_core_ip
set_property -dict [list \
    ...
    CONFIG.xk_index {0} \
] -objects [get_ips pfb_multichannel_fft_syn_config1_4_core_ip]
set_property generate_synth_checkpoint false [get_files pfb_multichannel_fft_syn_config1_4_core_ip.xci]
generate_target {synthesis simulation} [get_files pfb_multichannel_fft_syn_config1_4_core_ip.xci]
