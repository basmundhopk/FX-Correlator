...
wire    init_fft_config_U0_ap_start;
wire    init_fft_config_U0_start_full_n;
wire    init_fft_config_U0_ap_done;
wire    init_fft_config_U0_ap_continue;
wire    init_fft_config_U0_ap_idle;
wire    init_fft_config_U0_ap_ready;
wire    init_fft_config_U0_start_out;
wire    init_fft_config_U0_start_write;
wire   [15:0] init_fft_config_U0_cfg0_s_din;
wire    init_fft_config_U0_cfg0_s_write;
wire   [15:0] init_fft_config_U0_cfg1_s_din;
wire    init_fft_config_U0_cfg1_s_write;
wire   [15:0] init_fft_config_U0_cfg2_s_din;
wire    init_fft_config_U0_cfg2_s_write;
wire   [15:0] init_fft_config_U0_cfg3_s_din;
wire    init_fft_config_U0_cfg3_s_write;
...
wire    capture_status_U0_ap_start;
wire    capture_status_U0_ap_done;
wire    capture_status_U0_ap_continue;
wire    capture_status_U0_ap_idle;
wire    capture_status_U0_ap_ready;
wire    capture_status_U0_stat0_s_read;
wire    capture_status_U0_stat1_s_read;
wire    capture_status_U0_stat2_s_read;
wire    capture_status_U0_stat3_s_read;
wire    cfg0_s_full_n;
...
wire   [10:0] ch0_in_num_data_valid;
wire   [10:0] ch0_in_fifo_cap;
wire    ch0_in_empty_n;
wire    ch1_in_full_n;
wire   [31:0] ch1_in_dout;
wire   [10:0] ch1_in_num_data_valid;
wire   [10:0] ch1_in_fifo_cap;
wire    ch1_in_empty_n;
wire    ch2_in_full_n;
wire   [31:0] ch2_in_dout;
wire   [10:0] ch2_in_num_data_valid;
wire   [10:0] ch2_in_fifo_cap;
wire    ch2_in_empty_n;
wire    ch3_in_full_n;
wire   [31:0] ch3_in_dout;
wire   [10:0] ch3_in_num_data_valid;
wire   [10:0] ch3_in_fifo_cap;
wire    ch3_in_empty_n;
wire    ch0_out_full_n;
wire   [31:0] ch0_out_dout;
wire   [10:0] ch0_out_num_data_valid;
wire   [10:0] ch0_out_fifo_cap;
...
wire   [10:0] ch1_out_num_data_valid;
wire   [10:0] ch1_out_fifo_cap;
...
wire   [10:0] ch2_out_num_data_valid;
wire   [10:0] ch2_out_fifo_cap;
...
wire   [10:0] ch3_out_num_data_valid;
wire   [10:0] ch3_out_fifo_cap;
...
wire    ap_sync_done;
wire    ap_sync_ready;
reg    ap_sync_reg_init_fft_config_U0_ap_ready;
wire    ap_sync_init_fft_config_U0_ap_ready;
...
wire   [0:0] start_for_capture_status_U0_din;
wire    start_for_capture_status_U0_full_n;
wire   [0:0] start_for_capture_status_U0_dout;
wire    start_for_capture_status_U0_empty_n;
wire    ap_ce_reg;

// power-on initialization
initial begin
#0 start_once_reg = 1'b0;
#0 ap_sync_reg_init_fft_config_U0_ap_ready = 1'b0;
#0 ap_sync_reg_unpack_U0_ap_ready = 1'b0;
end

pfb_multichannel_init_fft_config init_fft_config_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
pfb_multichannel_capture_status capture_status_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
pfb_multichannel_fifo_w32_d1024_A ch0_in_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
pfb_multichannel_fifo_w32_d1024_A ch1_in_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
pfb_multichannel_fifo_w32_d1024_A ch2_in_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
pfb_multichannel_fifo_w32_d1024_A ch3_in_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
pfb_multichannel_fifo_w32_d1024_A ch0_out_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
pfb_multichannel_fifo_w32_d1024_A ch1_out_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
pfb_multichannel_fifo_w32_d1024_A ch2_out_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
pfb_multichannel_fifo_w32_d1024_A ch3_out_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
pfb_multichannel_start_for_capture_status_U0 start_for_capture_status_U0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ap_sync_reg_init_fft_config_U0_ap_ready <= 1'b0;
    end else begin
...
assign ap_idle = (unpack_U0_ap_idle & repack_U0_ap_idle & init_fft_config_U0_ap_idle & capture_status_U0_ap_idle);

assign ap_ready = ap_sync_ready;

assign ap_sync_continue = (ap_sync_done & ap_continue);

assign ap_sync_done = (repack_U0_ap_done & capture_status_U0_ap_done);

assign ap_sync_init_fft_config_U0_ap_ready = (init_fft_config_U0_ap_ready | ap_sync_reg_init_fft_config_U0_ap_ready);

assign ap_sync_ready = (ap_sync_unpack_U0_ap_ready & ap_sync_init_fft_config_U0_ap_ready);

assign ap_sync_unpack_U0_ap_ready = (unpack_U0_ap_ready | ap_sync_reg_unpack_U0_ap_ready);

assign capture_status_U0_ap_continue = ap_sync_continue;

assign capture_status_U0_ap_start = start_for_capture_status_U0_empty_n;

assign init_fft_config_U0_ap_continue = 1'b1;

assign init_fft_config_U0_ap_start = (real_start & (ap_sync_reg_init_fft_config_U0_ap_ready ^ 1'b1));

assign init_fft_config_U0_start_full_n = (start_for_repack_U0_full_n & start_for_capture_status_U0_full_n);
...
assign start_for_capture_status_U0_din = 1'b1;
