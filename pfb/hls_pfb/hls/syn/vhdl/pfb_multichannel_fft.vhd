...
attribute shreg_extract : string;
    ...
    signal fft_Block_entry13_proc1_U0_ap_start : STD_LOGIC;
    signal fft_Block_entry13_proc1_U0_ap_done : STD_LOGIC;
    signal fft_Block_entry13_proc1_U0_ap_continue : STD_LOGIC;
    signal fft_Block_entry13_proc1_U0_ap_idle : STD_LOGIC;
    signal fft_Block_entry13_proc1_U0_ap_ready : STD_LOGIC;
    signal fft_Block_entry13_proc1_U0_cfg0_s_din : STD_LOGIC_VECTOR (15 downto 0);
    signal fft_Block_entry13_proc1_U0_cfg0_s_write : STD_LOGIC;
    signal fft_Block_entry13_proc1_U0_cfg1_s_din : STD_LOGIC_VECTOR (15 downto 0);
    signal fft_Block_entry13_proc1_U0_cfg1_s_write : STD_LOGIC;
    signal fft_Block_entry13_proc1_U0_cfg2_s_din : STD_LOGIC_VECTOR (15 downto 0);
    signal fft_Block_entry13_proc1_U0_cfg2_s_write : STD_LOGIC;
    signal fft_Block_entry13_proc1_U0_cfg3_s_din : STD_LOGIC_VECTOR (15 downto 0);
    signal fft_Block_entry13_proc1_U0_cfg3_s_write : STD_LOGIC;
    ...
    signal fft_Block_entry19_proc2_U0_ap_start : STD_LOGIC;
    signal fft_Block_entry19_proc2_U0_ap_done : STD_LOGIC;
    signal fft_Block_entry19_proc2_U0_ap_continue : STD_LOGIC;
    signal fft_Block_entry19_proc2_U0_ap_idle : STD_LOGIC;
    signal fft_Block_entry19_proc2_U0_ap_ready : STD_LOGIC;
    signal fft_Block_entry19_proc2_U0_stat0_s_read : STD_LOGIC;
    signal fft_Block_entry19_proc2_U0_stat1_s_read : STD_LOGIC;
    signal fft_Block_entry19_proc2_U0_stat2_s_read : STD_LOGIC;
    signal fft_Block_entry19_proc2_U0_stat3_s_read : STD_LOGIC;
    signal ch0_in_full_n : STD_LOGIC;
    signal ch0_in_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal ch0_in_num_data_valid : STD_LOGIC_VECTOR (2 downto 0);
    signal ch0_in_fifo_cap : STD_LOGIC_VECTOR (2 downto 0);
    signal ch0_in_empty_n : STD_LOGIC;
    signal ch1_in_full_n : STD_LOGIC;
    signal ch1_in_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal ch1_in_num_data_valid : STD_LOGIC_VECTOR (2 downto 0);
    signal ch1_in_fifo_cap : STD_LOGIC_VECTOR (2 downto 0);
    signal ch1_in_empty_n : STD_LOGIC;
    signal ch2_in_full_n : STD_LOGIC;
    signal ch2_in_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal ch2_in_num_data_valid : STD_LOGIC_VECTOR (2 downto 0);
    signal ch2_in_fifo_cap : STD_LOGIC_VECTOR (2 downto 0);
    signal ch2_in_empty_n : STD_LOGIC;
    signal ch3_in_full_n : STD_LOGIC;
    signal ch3_in_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal ch3_in_num_data_valid : STD_LOGIC_VECTOR (2 downto 0);
    signal ch3_in_fifo_cap : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal ch0_out_num_data_valid : STD_LOGIC_VECTOR (2 downto 0);
    signal ch0_out_fifo_cap : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal ch1_out_num_data_valid : STD_LOGIC_VECTOR (2 downto 0);
    signal ch1_out_fifo_cap : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal ch2_out_num_data_valid : STD_LOGIC_VECTOR (2 downto 0);
    signal ch2_out_fifo_cap : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal ch3_out_num_data_valid : STD_LOGIC_VECTOR (2 downto 0);
    signal ch3_out_fifo_cap : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal ap_sync_reg_fft_Block_entry13_proc1_U0_ap_ready : STD_LOGIC := '0';
    signal ap_sync_fft_Block_entry13_proc1_U0_ap_ready : STD_LOGIC;
    ...
    signal start_for_fft_Block_entry19_proc2_U0_din : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_fft_Block_entry19_proc2_U0_full_n : STD_LOGIC;
    signal start_for_fft_Block_entry19_proc2_U0_dout : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_fft_Block_entry19_proc2_U0_empty_n : STD_LOGIC;
    ...
    port (
        ...
        ch0_in_num_data_valid : IN STD_LOGIC_VECTOR (2 downto 0);
        ch0_in_fifo_cap : IN STD_LOGIC_VECTOR (2 downto 0);
        ch0_in_full_n : IN STD_LOGIC;
        ch0_in_write : OUT STD_LOGIC;
        ch1_in_din : OUT STD_LOGIC_VECTOR (31 downto 0);
        ch1_in_num_data_valid : IN STD_LOGIC_VECTOR (2 downto 0);
        ch1_in_fifo_cap : IN STD_LOGIC_VECTOR (2 downto 0);
        ch1_in_full_n : IN STD_LOGIC;
        ch1_in_write : OUT STD_LOGIC;
        ch2_in_din : OUT STD_LOGIC_VECTOR (31 downto 0);
        ch2_in_num_data_valid : IN STD_LOGIC_VECTOR (2 downto 0);
        ch2_in_fifo_cap : IN STD_LOGIC_VECTOR (2 downto 0);
        ch2_in_full_n : IN STD_LOGIC;
        ch2_in_write : OUT STD_LOGIC;
        ch3_in_din : OUT STD_LOGIC_VECTOR (31 downto 0);
        ch3_in_num_data_valid : IN STD_LOGIC_VECTOR (2 downto 0);
        ch3_in_fifo_cap : IN STD_LOGIC_VECTOR (2 downto 0);
    ...
    component pfb_multichannel_fft_Block_entry13_proc1 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    port (
        ...
        ch0_out_num_data_valid : IN STD_LOGIC_VECTOR (2 downto 0);
        ch0_out_fifo_cap : IN STD_LOGIC_VECTOR (2 downto 0);
        ch0_out_empty_n : IN STD_LOGIC;
        ch0_out_read : OUT STD_LOGIC;
        ch1_out_dout : IN STD_LOGIC_VECTOR (31 downto 0);
        ch1_out_num_data_valid : IN STD_LOGIC_VECTOR (2 downto 0);
        ch1_out_fifo_cap : IN STD_LOGIC_VECTOR (2 downto 0);
        ch1_out_empty_n : IN STD_LOGIC;
        ch1_out_read : OUT STD_LOGIC;
        ch2_out_dout : IN STD_LOGIC_VECTOR (31 downto 0);
        ch2_out_num_data_valid : IN STD_LOGIC_VECTOR (2 downto 0);
        ch2_out_fifo_cap : IN STD_LOGIC_VECTOR (2 downto 0);
        ch2_out_empty_n : IN STD_LOGIC;
        ch2_out_read : OUT STD_LOGIC;
        ch3_out_dout : IN STD_LOGIC_VECTOR (31 downto 0);
        ch3_out_num_data_valid : IN STD_LOGIC_VECTOR (2 downto 0);
        ch3_out_fifo_cap : IN STD_LOGIC_VECTOR (2 downto 0);
    ...
    component pfb_multichannel_fft_Block_entry19_proc2 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component pfb_multichannel_fifo_w32_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component pfb_multichannel_start_for_fft_Block_entry19_proc2_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    ...
    port map (
        ...
        stream_compute_to_fft_num_data_valid => ap_const_lv13_0,
        stream_compute_to_fft_fifo_cap => ap_const_lv13_0,
    ...
    fft_Block_entry13_proc1_U0 : component pfb_multichannel_fft_Block_entry13_proc1
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    port map (
        ...
        stream_fft_to_write_num_data_valid => ap_const_lv13_0,
        stream_fft_to_write_fifo_cap => ap_const_lv13_0,
        stream_fft_to_write_full_n => stream_fft_to_write_full_n,
        stream_fft_to_write_write => repack_U0_stream_fft_to_write_write);

    fft_Block_entry19_proc2_U0 : component pfb_multichannel_fft_Block_entry19_proc2
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    ch0_in_U : component pfb_multichannel_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
    ...
    ch1_in_U : component pfb_multichannel_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ch2_in_U : component pfb_multichannel_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ch3_in_U : component pfb_multichannel_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ch0_out_U : component pfb_multichannel_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ch1_out_U : component pfb_multichannel_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ch2_out_U : component pfb_multichannel_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ch3_out_U : component pfb_multichannel_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_fft_Block_entry19_proc2_U0_U : component pfb_multichannel_start_for_fft_Block_entry19_proc2_U0
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ap_sync_reg_fft_Block_entry13_proc1_U0_ap_ready_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ap_sync_reg_fft_Block_entry13_proc1_U0_ap_ready <= ap_const_logic_0;
            else
    ...
    ap_idle <= (unpack_U0_ap_idle and repack_U0_ap_idle and fft_Block_entry19_proc2_U0_ap_idle and fft_Block_entry13_proc1_U0_ap_idle);
    ap_ready <= ap_sync_ready;
    ap_sync_continue <= (ap_sync_done and ap_continue);
    ap_sync_done <= (repack_U0_ap_done and fft_Block_entry19_proc2_U0_ap_done);
    ap_sync_fft_Block_entry13_proc1_U0_ap_ready <= (fft_Block_entry13_proc1_U0_ap_ready or ap_sync_reg_fft_Block_entry13_proc1_U0_ap_ready);
    ap_sync_ready <= (ap_sync_unpack_U0_ap_ready and ap_sync_fft_Block_entry13_proc1_U0_ap_ready);
    ap_sync_unpack_U0_ap_ready <= (unpack_U0_ap_ready or ap_sync_reg_unpack_U0_ap_ready);
    fft_Block_entry13_proc1_U0_ap_continue <= ap_const_logic_1;
    fft_Block_entry13_proc1_U0_ap_start <= (real_start and (ap_sync_reg_fft_Block_entry13_proc1_U0_ap_ready xor ap_const_logic_1));
    fft_Block_entry19_proc2_U0_ap_continue <= ap_sync_continue;
    fft_Block_entry19_proc2_U0_ap_start <= start_for_fft_Block_entry19_proc2_U0_empty_n;
    ...
    start_for_fft_Block_entry19_proc2_U0_din <= (0=>ap_const_logic_1, others=>'-');
    ...
    unpack_U0_start_full_n <= (start_for_repack_U0_full_n and start_for_fft_Block_entry19_proc2_U0_full_n);
end behav;
