...
if {[file isfile pfb_multichannel.autotvin.dat]} {
	file delete -force pfb_multichannel.autotvin.dat
}

if {[file isfile pfb_multichannel.autotvout.dat]} {
	file delete -force pfb_multichannel.autotvout.dat
}
