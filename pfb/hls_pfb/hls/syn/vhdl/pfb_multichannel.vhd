...
architecture behav of pfb_multichannel is 
    ...
    signal stream_read_to_compute_num_data_valid : STD_LOGIC_VECTOR (12 downto 0);
    signal stream_read_to_compute_fifo_cap : STD_LOGIC_VECTOR (12 downto 0);
    ...
    signal stream_compute_to_fft_num_data_valid : STD_LOGIC_VECTOR (12 downto 0);
    signal stream_compute_to_fft_fifo_cap : STD_LOGIC_VECTOR (12 downto 0);
    ...
    signal stream_fft_to_write_num_data_valid : STD_LOGIC_VECTOR (12 downto 0);
    signal stream_fft_to_write_fifo_cap : STD_LOGIC_VECTOR (12 downto 0);
    ...
    component pfb_multichannel_fifo_w128_d4096_A IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
...
begin
    ...
    stream_read_to_compute_U : component pfb_multichannel_fifo_w128_d4096_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
    ...
    stream_compute_to_fft_U : component pfb_multichannel_fifo_w128_d4096_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    stream_fft_to_write_U : component pfb_multichannel_fifo_w128_d4096_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
