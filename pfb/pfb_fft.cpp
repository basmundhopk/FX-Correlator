...
void fft(
    ...
    hls::stream<std::complex<data_t>> ch0_in("ch0_in"), ch0_out("ch0_out");
    hls::stream<std::complex<data_t>> ch1_in("ch1_in"), ch1_out("ch1_out");
    hls::stream<std::complex<data_t>> ch2_in("ch2_in"), ch2_out("ch2_out");
    hls::stream<std::complex<data_t>> ch3_in("ch3_in"), ch3_out("ch3_out");
    ...
    repack(ch0_out, ch1_out, ch2_out, ch3_out,  
                      internal_out);
