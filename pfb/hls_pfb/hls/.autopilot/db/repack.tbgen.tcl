...
set portList { 
	...
	{ stream_fft_to_write_num_data_valid sc_in sc_lv 13 signal 4 } 
	{ stream_fft_to_write_fifo_cap sc_in sc_lv 13 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "ch0_out_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "ch0_out", "role": "num_data_valid" }} , 
 	{ "name": "ch0_out_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "ch0_out", "role": "fifo_cap" }} , 
 	...
 	{ "name": "ch1_out_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "ch1_out", "role": "num_data_valid" }} , 
 	{ "name": "ch1_out_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "ch1_out", "role": "fifo_cap" }} , 
 	...
 	{ "name": "ch2_out_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "ch2_out", "role": "num_data_valid" }} , 
 	{ "name": "ch2_out_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "ch2_out", "role": "fifo_cap" }} , 
 	...
 	{ "name": "ch3_out_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "ch3_out", "role": "num_data_valid" }} , 
 	{ "name": "ch3_out_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "ch3_out", "role": "fifo_cap" }} , 
 	...
 	{ "name": "stream_fft_to_write_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "stream_fft_to_write", "role": "num_data_valid" }} , 
 	{ "name": "stream_fft_to_write_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "stream_fft_to_write", "role": "fifo_cap" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "ch0_out", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0","-1"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "ch0_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "ch1_out", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0","-1"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "ch1_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "ch2_out", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0","-1"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "ch2_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "ch3_out", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0","-1"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	ch0_out { ap_fifo {  { ch0_out_dout fifo_data_in 0 32 }  { ch0_out_num_data_valid fifo_status_num_data_valid 0 3 }  { ch0_out_fifo_cap fifo_update 0 3 }  { ch0_out_empty_n fifo_status 0 1 }  { ch0_out_read fifo_port_we 1 1 } } }
	ch1_out { ap_fifo {  { ch1_out_dout fifo_data_in 0 32 }  { ch1_out_num_data_valid fifo_status_num_data_valid 0 3 }  { ch1_out_fifo_cap fifo_update 0 3 }  { ch1_out_empty_n fifo_status 0 1 }  { ch1_out_read fifo_port_we 1 1 } } }
	ch2_out { ap_fifo {  { ch2_out_dout fifo_data_in 0 32 }  { ch2_out_num_data_valid fifo_status_num_data_valid 0 3 }  { ch2_out_fifo_cap fifo_update 0 3 }  { ch2_out_empty_n fifo_status 0 1 }  { ch2_out_read fifo_port_we 1 1 } } }
	ch3_out { ap_fifo {  { ch3_out_dout fifo_data_in 0 32 }  { ch3_out_num_data_valid fifo_status_num_data_valid 0 3 }  { ch3_out_fifo_cap fifo_update 0 3 }  { ch3_out_empty_n fifo_status 0 1 }  { ch3_out_read fifo_port_we 1 1 } } }
	stream_fft_to_write { ap_fifo {  { stream_fft_to_write_din fifo_data_in 1 128 }  { stream_fft_to_write_num_data_valid fifo_status_num_data_valid 0 13 }  { stream_fft_to_write_fifo_cap fifo_update 0 13 }  { stream_fft_to_write_full_n fifo_status 0 1 }  { stream_fft_to_write_write fifo_port_we 1 1 } } }
}
