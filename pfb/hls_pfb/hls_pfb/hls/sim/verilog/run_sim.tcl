...
if {[file isfile pfb_multichannel_decimator.autotvin.dat]} {
	file delete -force pfb_multichannel_decimator.autotvin.dat
}

if {[file isfile pfb_multichannel_decimator.autotvout.dat]} {
	file delete -force pfb_multichannel_decimator.autotvout.dat
}
