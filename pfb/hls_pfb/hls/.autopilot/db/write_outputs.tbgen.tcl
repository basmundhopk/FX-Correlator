...
set portList { 
	...
	{ stream_fft_to_write_num_data_valid sc_in sc_lv 13 signal 0 } 
	{ stream_fft_to_write_fifo_cap sc_in sc_lv 13 signal 0 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "stream_fft_to_write", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0","-1"], "DependentChan" : "0", "DependentChanDepth" : "4096", "DependentChanType" : "0",
				"BlockSignal" : [
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_dout_data_0_U", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_dout_data_1_U", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_dout_data_2_U", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_dout_data_3_U", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	stream_fft_to_write { ap_fifo {  { stream_fft_to_write_dout fifo_data_in 0 128 }  { stream_fft_to_write_num_data_valid fifo_status_num_data_valid 0 13 }  { stream_fft_to_write_fifo_cap fifo_update 0 13 }  { stream_fft_to_write_empty_n fifo_status 0 1 }  { stream_fft_to_write_read fifo_port_we 1 1 } } }
	dout_data_0 { axis {  { dout_data_0_TREADY out_acc 0 1 }  { dout_data_0_TDATA out_data 1 32 }  { dout_data_0_TVALID out_vld 1 1 } } }
	dout_data_1 { axis {  { dout_data_1_TREADY out_acc 0 1 }  { dout_data_1_TDATA out_data 1 32 }  { dout_data_1_TVALID out_vld 1 1 } } }
	dout_data_2 { axis {  { dout_data_2_TREADY out_acc 0 1 }  { dout_data_2_TDATA out_data 1 32 }  { dout_data_2_TVALID out_vld 1 1 } } }
	dout_data_3 { axis {  { dout_data_3_TREADY out_acc 0 1 }  { dout_data_3_TDATA out_data 1 32 }  { dout_data_3_TVALID out_vld 1 1 } } }
}
