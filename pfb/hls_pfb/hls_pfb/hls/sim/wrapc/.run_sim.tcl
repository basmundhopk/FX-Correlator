...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "pfb_multichannel_decimator.autotvin.dat"
	set constFileTvOut       "pfb_multichannel_decimator.autotvout.dat"
	set constFileHdlTvIn     "pfb_multichannel_decimator.autohdltvin.dat"
	set constFileHdlTvOut    "pfb_multichannel_decimator.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
