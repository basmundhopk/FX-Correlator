...
entry:
  call fastcc void @"onebyonecpy_hls.p0struct.hls::ip_fft::config_t<config1>.115"(%"struct.hls::ip_fft::config_t<config1>"* %0, i16* align 512 %1)
  call fastcc void @"onebyonecpy_hls.p0struct.hls::ip_fft::config_t<config1>.115"(%"struct.hls::ip_fft::config_t<config1>"* %2, i16* align 512 %3)
  call fastcc void @"onebyonecpy_hls.p0struct.hls::ip_fft::config_t<config1>.115"(%"struct.hls::ip_fft::config_t<config1>"* %4, i16* align 512 %5)
  call fastcc void @"onebyonecpy_hls.p0struct.hls::ip_fft::config_t<config1>.115"(%"struct.hls::ip_fft::config_t<config1>"* %6, i16* align 512 %7)
  call fastcc void @"onebyonecpy_hls.p0struct.hls::ip_fft::config_t<config1>.115"(%"struct.hls::ip_fft::config_t<config1>"* %8, i16* align 512 %9)
  call fastcc void @"onebyonecpy_hls.p0struct.hls::ip_fft::config_t<config1>.115"(%"struct.hls::ip_fft::config_t<config1>"* %10, i16* align 512 %11)
  call fastcc void @"onebyonecpy_hls.p0struct.hls::ip_fft::config_t<config1>.115"(%"struct.hls::ip_fft::config_t<config1>"* %12, i16* align 512 %13)
  call fastcc void @"onebyonecpy_hls.p0struct.hls::ip_fft::config_t<config1>.115"(%"struct.hls::ip_fft::config_t<config1>"* %14, i16* align 512 %15)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>, 0>.86"(%"class.hls::stream<ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>, 0>"* %16, i32* align 512 %17)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>, 0>.86"(%"class.hls::stream<ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>, 0>"* %18, i32* align 512 %19)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>, 0>.86"(%"class.hls::stream<ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>, 0>"* %20, i32* align 512 %21)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>, 0>.86"(%"class.hls::stream<ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>, 0>"* %22, i32* align 512 %23)
  call fastcc void @"onebyonecpy_hls.p0a4096struct.ap_uint<16>.69"([4096 x %"struct.ap_uint<16>"]* %24, [4096 x i16]* %25)
  ret void
}
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @"onebyonecpy_hls.p0a4096struct.ap_uint<16>.69"([4096 x %"struct.ap_uint<16>"]* noalias "unpacked"="0" %dst, [4096 x i16]* noalias nocapture readonly "unpacked"="1.0" %src) unnamed_addr #3 {
entry:
  %0 = icmp eq [4096 x %"struct.ap_uint<16>"]* %dst, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a4096struct.ap_uint<16>.72"([4096 x %"struct.ap_uint<16>"]* nonnull %dst, [4096 x i16]* %src, i64 4096)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a4096struct.ap_uint<16>.72"([4096 x %"struct.ap_uint<16>"]* "unpacked"="0" %dst, [4096 x i16]* nocapture readonly "unpacked"="1.0" %src, i64 "unpacked"="2" %num) local_unnamed_addr #4 {
entry:
  %0 = icmp eq [4096 x %"struct.ap_uint<16>"]* %dst, null
  br i1 %0, label %ret, label %copy
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>, 0>.82"(i32* align 512 %dst, %"class.hls::stream<ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>, 0>"* nonnull %src)
  br label %ret
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>, 0>.82"(i32* noalias nocapture align 512 "unpacked"="0.0", %"class.hls::stream<ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>, 0>"* noalias nocapture "unpacked"="1") unnamed_addr #7 {
entry:
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>, 0>.86"(%"class.hls::stream<ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>, 0>"* noalias "unpacked"="0" %dst, i32* noalias nocapture align 512 "unpacked"="1.0" %src) unnamed_addr #6 {
entry:
  %0 = icmp eq %"class.hls::stream<ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>, 0>"* %dst, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>, 0>.89"(%"class.hls::stream<ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>, 0>"* nonnull %dst, i32* align 512 %src)
  br label %ret
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>, 0>.89"(%"class.hls::stream<ap_fixed<32, 1, AP_TRN, AP_WRAP, 0>, 0>"* noalias nocapture "unpacked"="0", i32* noalias nocapture align 512 "unpacked"="1.0") unnamed_addr #7 {
entry:
  %2 = alloca i32
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0struct.hls::ip_fft::config_t<config1>.111"(i16* align 512 %dst, %"struct.hls::ip_fft::config_t<config1>"* nonnull %src)
  br label %ret
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"streamcpy_hls.p0struct.hls::ip_fft::config_t<config1>.111"(i16* noalias nocapture align 512 "unpacked"="0.0", %"struct.hls::ip_fft::config_t<config1>"* noalias nocapture "unpacked"="1") unnamed_addr #7 {
entry:
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"onebyonecpy_hls.p0struct.hls::ip_fft::config_t<config1>.115"(%"struct.hls::ip_fft::config_t<config1>"* noalias "unpacked"="0" %dst, i16* noalias nocapture align 512 "unpacked"="1.0" %src) unnamed_addr #6 {
entry:
  %0 = icmp eq %"struct.hls::ip_fft::config_t<config1>"* %dst, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0struct.hls::ip_fft::config_t<config1>.118"(%"struct.hls::ip_fft::config_t<config1>"* nonnull %dst, i16* align 512 %src)
  br label %ret
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"streamcpy_hls.p0struct.hls::ip_fft::config_t<config1>.118"(%"struct.hls::ip_fft::config_t<config1>"* noalias nocapture "unpacked"="0", i16* noalias nocapture align 512 "unpacked"="1.0") unnamed_addr #7 {
entry:
  %2 = alloca i16
