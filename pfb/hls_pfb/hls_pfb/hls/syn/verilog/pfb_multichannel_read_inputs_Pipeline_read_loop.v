...
module pfb_multichannel_read_inputs_Pipeline_read_loop (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg din_data_i0_TREADY;
reg din_data_q0_TREADY;
reg din_data_i1_TREADY;
reg din_data_q1_TREADY;
reg din_data_i2_TREADY;
reg din_data_q2_TREADY;
reg din_data_i3_TREADY;
reg din_data_q3_TREADY;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln17_fu_123_p2 == 1'd0) & (ap_start_int == 1'b1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (icmp_ln17_fu_123_p2 == 1'd1) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (icmp_ln17_fu_123_p2 == 1'd0) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln17_fu_123_p2 == 1'd0) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        din_data_i0_TREADY = 1'b1;
    end else begin
        din_data_i0_TREADY = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln17_fu_123_p2 == 1'd0) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        din_data_i1_TREADY = 1'b1;
    end else begin
        din_data_i1_TREADY = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln17_fu_123_p2 == 1'd0) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        din_data_i2_TREADY = 1'b1;
    end else begin
        din_data_i2_TREADY = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln17_fu_123_p2 == 1'd0) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        din_data_i3_TREADY = 1'b1;
    end else begin
        din_data_i3_TREADY = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln17_fu_123_p2 == 1'd0) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        din_data_q0_TREADY = 1'b1;
    end else begin
        din_data_q0_TREADY = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln17_fu_123_p2 == 1'd0) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        din_data_q1_TREADY = 1'b1;
    end else begin
        din_data_q1_TREADY = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln17_fu_123_p2 == 1'd0) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        din_data_q2_TREADY = 1'b1;
    end else begin
        din_data_q2_TREADY = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln17_fu_123_p2 == 1'd0) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        din_data_q3_TREADY = 1'b1;
    end else begin
        din_data_q3_TREADY = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_state1_pp0_stage0_iter0 = (((din_data_q3_TVALID == 1'b0) & (icmp_ln17_fu_123_p2 == 1'd0)) | ((din_data_i3_TVALID == 1'b0) & (icmp_ln17_fu_123_p2 == 1'd0)) | ((din_data_q2_TVALID == 1'b0) & (icmp_ln17_fu_123_p2 == 1'd0)) | ((din_data_i2_TVALID == 1'b0) & (icmp_ln17_fu_123_p2 == 1'd0)) | ((din_data_q1_TVALID == 1'b0) & (icmp_ln17_fu_123_p2 == 1'd0)) | ((din_data_i1_TVALID == 1'b0) & (icmp_ln17_fu_123_p2 == 1'd0)) | ((din_data_q0_TVALID == 1'b0) & (icmp_ln17_fu_123_p2 == 1'd0)) | ((icmp_ln17_fu_123_p2 == 1'd0) & (din_data_i0_TVALID == 1'b0)));
end
...
assign icmp_ln17_fu_123_p2 = ((ap_sig_allocacmp_i_7 == 11'd1024) ? 1'b1 : 1'b0);
...
endmodule //pfb_multichannel_read_inputs_Pipeline_read_loop
