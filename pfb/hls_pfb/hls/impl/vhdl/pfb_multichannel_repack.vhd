...
attribute shreg_extract : string;
    ...
    signal icmp_ln89_fu_87_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal i_6_fu_93_p2 : STD_LOGIC_VECTOR (10 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_1 = ap_condition_116)) then
                if ((icmp_ln89_fu_87_p2 = ap_const_lv1_0)) then 
    ...
    ap_block_state2_pp0_stage0_iter1_assign_proc : process(ch0_out_empty_n, ch1_out_empty_n, ch2_out_empty_n, ch3_out_empty_n, stream_fft_to_write_full_n)
    begin
                ap_block_state2_pp0_stage0_iter1 <= ((stream_fft_to_write_full_n = ap_const_logic_0) or (ch3_out_empty_n = ap_const_logic_0) or (ch2_out_empty_n = ap_const_logic_0) or (ch1_out_empty_n = ap_const_logic_0) or (ch0_out_empty_n = ap_const_logic_0));
    end process;
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_subdone, icmp_ln89_fu_87_p2, ap_start_int)
    begin
        if (((icmp_ln89_fu_87_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    ap_sig_allocacmp_i_5_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, i_fu_44, ap_loop_init, ap_start_int)
    begin
    ...
    i_6_fu_93_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_5) + unsigned(ap_const_lv11_1));
    icmp_ln89_fu_87_p2 <= "1" when (ap_sig_allocacmp_i_5 = ap_const_lv11_400) else "0";

    stream_fft_to_write_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, stream_fft_to_write_full_n, ap_block_pp0_stage0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    stream_fft_to_write_din <= (((ch3_out_dout & ch2_out_dout) & ch1_out_dout) & ch0_out_dout);

    stream_fft_to_write_write_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
