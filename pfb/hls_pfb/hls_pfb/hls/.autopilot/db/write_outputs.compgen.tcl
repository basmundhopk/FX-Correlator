...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { stream_compute_to_write_dout { I 128 vector } stream_compute_to_write_num_data_valid { I 5 vector } stream_compute_to_write_fifo_cap { I 5 vector } stream_compute_to_write_empty_n { I 1 bit } stream_compute_to_write_read { O 1 bit } } \
} "
}
...
# RegSlice definition:
set ID 118
set RegSliceName pfb_multichannel_decimator_regslice_both
set RegSliceInstName pfb_multichannel_decimator_regslice_both_U
set CoreName ap_simcore_pfb_multichannel_decimator_regslice_both
...
eval "::AESL_LIB_VIRTEX::xil_gen_regSlice { \
    name ${RegSliceName} \
    prefix pfb_multichannel_decimator_ \
    sliceTypeList 0\
}"
} else {
