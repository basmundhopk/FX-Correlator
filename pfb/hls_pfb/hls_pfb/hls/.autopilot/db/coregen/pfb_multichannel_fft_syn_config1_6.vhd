...
entity pfb_multichannel_fft_syn_config1_6 is
    generic (
...
architecture arch of pfb_multichannel_fft_syn_config1_6 is
    --------------------- Component ---------------------
    component pfb_multichannel_fft_syn_config1_6_core_ip is
        port (
            aclk                        : in  std_logic;
            aclken                      : in  std_logic;
...
begin
    --------------------- Instantiation -----------------
    inst : component pfb_multichannel_fft_syn_config1_6_core_ip
    port map (
        aclk                        => ap_clk,
        aclken                      => ap_ce,
        aresetn                     => aresetn,
