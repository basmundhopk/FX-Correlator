...
set name pfb_multichannel_mul_16s_16s_31_1_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {mul} IMPL {auto} LATENCY 0 ALLOW_PRAGMA 1
}
...
set id 67
set name pfb_multichannel_mac_muladd_16s_16s_31s_31_4_1
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler pfb_multichannel_decimate_pfb_decimate_pfb_stream_stream_ap_fixed_16_1_5_3_0_const_local_coeffbkb BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler pfb_multichannel_decimate_pfb_decimate_pfb_stream_stream_ap_fixed_16_1_5_3_0_const_branch_memog8j BINDTYPE {storage} TYPE {ram_1p} IMPL {bram} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { stream_read_to_compute_dout { I 128 vector } stream_read_to_compute_num_data_valid { I 13 vector } stream_read_to_compute_fifo_cap { I 13 vector } stream_read_to_compute_empty_n { I 1 bit } stream_read_to_compute_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { stream_compute_to_fft_din { O 128 vector } stream_compute_to_fft_num_data_valid { I 13 vector } stream_compute_to_fft_fifo_cap { I 13 vector } stream_compute_to_fft_full_n { I 1 bit } stream_compute_to_fft_write { O 1 bit } } \
} "
}
